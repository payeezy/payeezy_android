...
*/
	...
	//German Debit
	public Card getdCard(){return dCard;}
	public void setdCard(Card dCard) {
		this.dCard = dCard;
	}
...
public String getCurrencycode(){return currency_code;}
	public void setCurrency(String currency_code){ this.currency_code=currency_code;}

	public RateReference getRateReference(){return rateReference;}
