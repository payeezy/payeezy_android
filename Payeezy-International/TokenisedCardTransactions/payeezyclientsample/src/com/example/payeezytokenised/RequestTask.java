...
*/
		...
		//	trans.setReferenceNo("AstonishingSale");

			trans.setReferenceNo("AstonishingSale"+TransactionDataProvider.merchantref);
			//+ TransactionDataProvider.merchantref);
			//trans.setReferenceNo("abc1412096293369");
			trans.setTransactionType("Authorize");
			trans.setPaymentMethod("token");
			//trans.setAmount("1");
...
//TransactionResponse responseToken=new TransactionResponse();
			//ta.setValue("2833693264441732");
		//	ta.setValue("d7bb10e6-0c23-483d-af18-a2a4186939c9");
			//String s = responseToken.getToken().getTokenData().getValue();
...
*/
			...
			trans.setReferenceNo("Astonishing-Sale"+TransactionDataProvider.merchantref);
			//trans.setReferenceNo("Astonishing-Sale");
		//	trans.setReferenceNo("Astonishing-Sale");
			trans.setTransactionType("Purchase");
			trans.setPaymentMethod("token");
...
System.out.println("before calling capture");
	...
	/* JSON pay load for transarmor void
	 * Added for GET-Authvoid
	*/
	private void CallVoidVisaGetGetToken()
	{
		try
		{
			cardtypeSecondary = CardType.CARD_VISA;
...
//randomnumbergeneration();
			request.setReferenceNo("AstonishingSale"+TransactionDataProvider.getmerchantref());
			request.setCard(card) ;
        	request.getCard().setNumber("4788250000028291");
        	request.getCard().setName("John Smith");
        	request.getCard().setExpiryDt("1030");
        	request.getCard().setCvv("123");
        	request.getCard().setType("visa");
