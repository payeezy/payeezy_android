...
/*    private String getValue(String value){
    ...
    */
	...
	public String getReversalId(){return reversal_id;}
	public void setReversalId(String reversal_id){this.reversal_id=reversal_id;}
...
//For DCC
			...
			if(dataVals[0].contains("correlation_id"))
			{
				...
				TransactionResponse.correlationID=dataVals[1];
			}
