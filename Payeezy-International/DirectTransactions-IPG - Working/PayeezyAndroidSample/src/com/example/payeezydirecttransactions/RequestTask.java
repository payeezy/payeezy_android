...
public class RequestTask extends AsyncTask<String, String, String> {
	...
	protected String doInBackground(String... uri) {
		...
		if (uri[0].toLowerCase().equalsIgnoreCase("avsauthorizevoid")) {
			...
			AvsSdL2L3Ta3dszd(TransactionCategory.CATEGORY_AVS,TransactionTypePrimarySecondary.AUTHORIZE);
		...
		if (uri[0].toLowerCase().equalsIgnoreCase("avspurchasevoid")) {
			...
			AvsSdL2L3Ta3dszd(TransactionCategory.CATEGORY_AVS,TransactionTypePrimarySecondary.PURCHASE);
			PayloadFormSecondaryTransaction(TransactionCategory.CATEGORY_AVS,TransactionTypePrimarySecondary.VOID);
		...
		if (uri[0].toLowerCase().equalsIgnoreCase("3dsauthorizevoid")) {
			...
			AvsSdL2L3Ta3dszd(TransactionCategory.CATEGORY_3DS,TransactionTypePrimarySecondary.AUTHORIZE);
		...
		if (uri[0].toLowerCase().equalsIgnoreCase("3dspurchasevoid")) {
			...
			AvsSdL2L3Ta3dszd(TransactionCategory.CATEGORY_3DS,TransactionTypePrimarySecondary.PURCHASE);
			PayloadFormSecondaryTransaction(TransactionCategory.CATEGORY_3DS,TransactionTypePrimarySecondary.VOID);
...
//SD Transactions
		...
		if (uri[0].toLowerCase().equalsIgnoreCase("cvvauthorizevoid")) {
			AuthorizePurchase(TransactionTypePrimarySecondary.AUTHORIZE);
		//	AvsSdL2L3Ta3dszd(TransactionCategory.CATEGORY_SOFTDESCRIPTORS,TransactionTypePrimarySecondary.AUTHORIZE);
		...
		if (uri[0].toLowerCase().equalsIgnoreCase("cvvpurchasevoid")) {
			AuthorizePurchase(TransactionTypePrimarySecondary.PURCHASE);
		//	AvsSdL2L3Ta3dszd(TransactionCategory.CATEGORY_SOFTDESCRIPTORS,TransactionTypePrimarySecondary.PURCHASE);
			PayloadFormSecondaryTransaction(TransactionCategory.CATEGORY_CVV2,TransactionTypePrimarySecondary.VOID);
...
*/
		/*if (uri[0].toLowerCase().equalsIgnoreCase("authorizeavs")) {
			...
			AvsSdL2L3Ta3dszd(TransactionCategory.CATEGORY_AVS,);
			return "authorizeavs";
		}
		...
		if (uri[0].toLowerCase().equalsIgnoreCase("authorizesoftdescriptors")) {
			...
			AvsSdL2L3Ta3dszd(TransactionCategory.CATEGORY_SOFTDESCRIPTORS);
...
/*		if (uri[0].toLowerCase().equalsIgnoreCase("authorize3ds")) {
			...
			AvsSdL2L3Ta3dszd(TransactionCategory.CATEGORY_3DS);
			return "authorize3ds";
		}
*/
...
/*		if (uri[0].toLowerCase().equalsIgnoreCase("authorizelevel2")) {
			...
			AvsSdL2L3Ta3dszd(TransactionCategory.CATEGORY_LEVEL2);
			return "authorizelevel2";
		}
*/
/*		if (uri[0].toLowerCase().equalsIgnoreCase("authorizelevel3")) {

			AvsSdL2L3Ta3dszd(TransactionCategory.CATEGORY_LEVEL3);
...
/*		if (uri[0].toLowerCase().equalsIgnoreCase("zerodollar")) {
			AvsSdL2L3Ta3dszd(TransactionCategory.CATEGORY_ZERODOLLAR);
			return "zerodollar";
		}
...
*/
    ...
    */
	...
	private void AuthorizePurchase(TransactionTypePrimarySecondary transactionType) {
		try {
	...
	private void CaptureRefundVoid(TransactionTypePrimarySecondary transactionType) {
		try {
			Initialise();
			...
			if (transactionType == TransactionTypePrimarySecondary.CAPTURE)

				trans.setTransactionType(TransactionType.CAPTURE.name().toLowerCase());

			else if (transactionType == TransactionTypePrimarySecondary.REFUND)
...
TransactionResponse.transactionId=transaction_id;
	...
	private void AvsSdL2L3Ta3dszd(TransactionCategory transactionCategory,TransactionTypePrimarySecondary transactiontype)
	{
		try
		{
			Initialise();
...
/*************************Soft Descriptors********************/
	...
	private TransactionRequest getPrimaryTransaction() {
        ...
        Card card=new Card();
        card.setCvv("977");
        card.setExpiryDt("1218");
        card.setName("Eck Test 3");
        card.setType("visa");
        card.setNumber("4035874000424977");
...
address.setCity("St. Louis");
		address.setAddressLine1("12115 LACKLAND");
		address.setZip("63146");
		address.setCountry("US");
address.setEmail("abc@main.com");
