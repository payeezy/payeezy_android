...
//changed for GET
	...
	/*	https://api-qa.payeezy.com/v1/securitytokens?auth=false&apikey=ehCz1VGlwNeeGcN5LjA5c2nvWKTnEZRn&
		// js_security_key=js-4302e5e5bf1c511ad9899ef725fd40044302e5e5bf1c511a&callback=Payeezy.callback&
		// type=FDToken&credit_card.type=mastercard&credit_card.cardholder_name=xyz&credit_card.card_number=5424180279791732&currency=GBP
		// &credit_card.exp_date=0416&credit_card.cvv=123*/
	String	url="https://api-qa.payeezy.com/v1"+"/securitytokens?"
				+
				"auth=false&apikey=ehCz1VGlwNeeGcN5LjA5c2nvWKTnEZRn&"+
				"js_security_key=js-4302e5e5bf1c511ad9899ef725fd40044302e5e5bf1c511a&"
				+"callback=Payeezy.callback&"+"currency=GBP&"
				+"type=FDToken&"+"credit_card.type=visa&"+"credit_card.cardholder_name=John Smith&"+"credit_card.card_number=4035874000424977&" +
			"credit_card.exp_date=1030&"+"credit_card.cvv=123";

		/*https://api-qa.payeezy.com/v1/securitytokens?auth=false&apikey=ehCz1VGlwNeeGcN5LjA5c2nvWKTnEZRn&js_security_key
		// =js-4302e5e5bf1c511ad9899ef725fd40044302e5e5bf1c511a&callback=Payeezy.callback&type=FDToken&credit_card.type=visa&
		credit_card.cardholder_name=xyz&credit_card.card_number=4035874000424977¤cy=GBP&credit_card.exp_date=1030&credit_card.cvv=123
		 <https://api-qa.payeezy.com/v1/securitytokens?auth=false&apikey=ehCz1VGlwNeeGcN5LjA5c2nvWKTnEZRn&js_security_key=js-
		 4302e5e5bf1c511ad9899ef725fd40044302e5e5bf1c511a&callback=Payeezy.callback&type=FDToken&credit_card.type=visa&credit_
		 card.cardholder_name=xyz&credit_card.card_number=4035874000424977&currency=GBP&credit_card.exp_date=1030&credit_card.cvv=123> */
...
//         return null;
   ...
   public TransactionResponse doSecondaryTransactionObject(TransactionRequest trans) throws Exception {
     ...
     //   Assert.notNull(trans.getType(), "Transaction type is not present");
	   ...
	   url="https://api-qa.payeezy.com/v1/transactions/+{id}";
