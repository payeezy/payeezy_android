...
public class EnvCert {
	...
	public EnvCert(Context pcontext)
	{
		context = pcontext;
	...
	public void CallActivationValueLink()
	{
		try
		{
			...
			TransactionDataProviderVL tdp = new TransactionDataProviderVL();
	...
	public void CallRefundVisaNakedRefunds()
	{
		try
		{
			cardtypeSecondary = CardType.CARD_VISA;
	...
	public void CallVoidVisaNakedVoids()
	{
		try
		{
			cardtypeSecondary = CardType.CARD_VISA;
	...
	public void CallAuthorizeVisaRecurring()
	{
		try
		{
			cardtypeSecondary = CardType.CARD_VISA;
