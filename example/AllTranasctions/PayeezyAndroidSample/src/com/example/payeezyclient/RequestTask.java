	...
	*/
	...
	private void CallPurchaseTelecheck()
	{
		try
		{
			...
			clientHelper.setAppId(TransactionDataProvider.appIdTelecheck);
			clientHelper.setSecuredSecret(TransactionDataProvider.secureIdTelecheck);
		//	clientHelper.setToken(TransactionDataProvider.tokenTelecheck);
			clientHelper.setToken(TransactionDataProvider.tokenCert);
			clientHelper.setUrl(TransactionDataProvider.urlCert);
	...
	private void CallCaptureVisaGetToken()
	{
		try
		{
	        ...
	        */
			...
			TransactionResponse resp4 = responseObject4; //uresp4; //uresp.getBody();
	...
	private void CallRefundVisaGetToken()
	{
		try
		{
	        ...
	        */
			...
			TransactionResponse resp5 = responseObject5; //uresp5; //uresp.getBody();
	...
	*/
    ...
    public TransactionRequest getPrimaryTransactionForTransType() {
        ...
        if(category == TransactionCategory.CATEGORY_3DS)
        {
			...
			card.setEciIndicator(tdpl3.eci_indicator);
